// Improved hello
// Complete the following program so that it asks the user for his first 
// and last names, then show the result of the sayHello() function.
...
// Let's pretend the JavaScript Math.min() function doesn't exist. Complete the following 
// program so that the min() function returns the minimum of its two received numbers.
