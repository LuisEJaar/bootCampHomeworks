...
function weirdAddThenDivide (num1, num2, num3) {
...
//add the sum of the last two numbers and console log the value. If the
//product is less that 100, subtract the difference of the last two 
//numbers and console log the value. If the product is 100, multiply 
//the first three numbers together and alert the remainder of dividing
// the fourth number

function abunch (num1, num2, num3, num4) {
